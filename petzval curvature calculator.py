# -*- coding: utf-8 -*-
""" 
The following program calculates the petzval curvature of each surface in a given optical system configuration. 
...
# prints out the petzval curvature of each surface
for istep in range(0,len(petzvalCurvatureArray)):
    print("The petzval curvature of surface ",istep+1, " is ",petzvalCurvatureArray[istep])
