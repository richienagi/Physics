...
The program calculates the astigmatism introduced by each surface in the system, as well as the total astigmatism of the given 
...
totalAstigmatism = 0 #Initialize variable for storing sum of astigmatism aberration contributed by each surface
# prints out astigmatism contributed by each surface, as well as total astigmatism of the optical system
for istep in range(0,len(astigmatismArray)):
    totalAstigmatism = totalAstigmatism + astigmatismArray[istep]
    print("The astigmatism contributed by surface ",istep+1, " is ",astigmatismArray[istep])
    
print("The total astigmatism of the system is " ,totalAstigmatism)
