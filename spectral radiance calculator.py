...
#Print output
print("The Spectral Radiance emmited by the black body at a temperature of ",temperature," K and wavelength of ",wavelength," microns is ",spectralRadiance," W/(m^2-sr-m)")