...
# prints out coma contributed by each surface, as well as total coma of the optical system
totalComa = 0 #Initialize variable for storing sum of coma aberration contributed by each surface
